...
export ZSH="/home/bfserver/.oh-my-zsh"
...
alias remkrb5host="sudo kadmin.local -q 'delprinc -force host/krb5.michael.io'; sudo kadmin.local -q 'ktremove host/krb5.michael.io'"
alias remclienthost="sudo kadmin.local -q 'delprinc -force host/client.michael.io'; sudo kadmin.local -q 'ktremove host/client.michael.io'"
alias rembfclient="sudo kadmin.local -q 'delprinc -force bfclient'"
alias remall="remkrb5host; remclienthost; rembfclient"

alias addkrb5host="sudo kadmin.local -q 'addprinc -randkey host/krb5.michael.io'; sudo kadmin.local -q 'ktadd host/krb5.michael.io'"
alias addclienthost="sudo kadmin.local -q 'addprinc -randkey host/client.michael.io'; sudo kadmin.local -q 'ktadd host/client.michael.io'"
